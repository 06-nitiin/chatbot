...
SYSTEM_PROMPT = (
    "You are a small, friendkly chatbot bolted onto a rule-based keyword bot,"
...
class LLMUnavailable(Exception):
    """Raised when the LLM fallback cant be used (no key, network error, etc)."""

def is_configured():
    return bool(GEMINI_API_KEY)

def ask_llm(user_message, timeout=10):
